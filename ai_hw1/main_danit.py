...
def plot_distance_and_expanded_wrt_weight_figure(
    ...
    p1, = ax1.plot(weights, total_cost, color='b', label='Solution cost', linestyle='solid')
    ...
    p2, = ax2.plot(weights, total_nr_expanded, color='r', label='#Expanded states', linestyle='solid')
    # TODO: pass the relevant params instead of `...`.
...
def toy_map_problem_experiments():
    ...
    a_star_alg = AStar(NullHeuristic)
    res = a_star_alg.solve_problem(toy_map_problem)
    print(res)
    # Ex.13
    # TODO: create an instance of `AStar` with the `AirDistHeuristic`,
    #       solve the same `toy_map_problem` with it and print the results (as before).
    a_star_alg = AStar(AirDistHeuristic)
    res = a_star_alg.solve_problem(toy_map_problem)
    print(res)
    # Ex.15
    # TODO:
...
def mda_problem_with_astar_experiments():
    ...
    #       solve the `moderate_mda_problem_with_distance_cost` with it and print the results.
    a_star_alg = AStar(MDASumAirDistHeuristic)
    res = a_star_alg.solve_problem(moderate_mda_problem_with_distance_cost)
    print(res)
...
def mda_problem_with_astar_epsilon_experiments():
    ...
    astar_epsilon=AStarEpsilon(heuristic_function_type=MDAMSTAirDistHeuristic, within_focal_priority_function=
...
def mda_problem_anytime_astar_experiments():
    ...
    anytime_astar1 = AnytimeAStar(MDAMSTAirDistHeuristic, 1000)
    solution = anytime_astar1.solve_problem(moderate_mda_problem_with_distance_cost)
    print(solution)
